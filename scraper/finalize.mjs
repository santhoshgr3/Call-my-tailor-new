...
const site = {
  ...
  order_by_category: [
    { label: 'FORMAL SUIT', slug: 'suit-blazer/formal-suit', image: '/img/cat-formal-suit.jpg' },
    { label: 'PARTY SUIT', slug: 'suit-blazer/party-suits', image: '/img/cat-party-suit.jpg' },
    { label: 'TUXEDO', slug: 'suit-blazer/tuxedo', image: '/img/cat-tuxedo.jpg' },
    { label: 'BANDHGALA SUIT', slug: 'ethnic-wear/bandhgala-suit', image: '/img/cat-bandhgala.jpg' },
    { label: 'INDO WESTERN', slug: 'ethnic-wear/indo-western', image: '/img/cat-indo-western.jpg' },
    { label: 'SHERWANI', slug: 'wedding-attire/sherwani', image: '/img/cat-sherwani.jpg' },
    { label: 'KURTA', slug: 'kurta', image: '/img/cat-kurta.jpg' },
  ],
  ...
  footer_video: 'https://www.youtube.com/watch?v=88RmDQejfyQ',
  footer_gallery: [
    { image: '/img/foot-ig-1.jpg', href: 'https://www.instagram.com/doorstep_tailor_drapper/' },
    { image: '/img/foot-ig-2.jpg', href: 'https://www.instagram.com/doorstep_tailor_drapper/' },
    { image: '/img/foot-ig-3.jpg', href: 'https://www.instagram.com/doorstep_tailor_drapper/' },
    { image: '/img/foot-ig-4.jpg', href: 'https://www.instagram.com/doorstep_tailor_drapper/' },
    { image: '/img/foot-ig-5.jpg', href: 'https://www.instagram.com/doorstep_tailor_drapper/' },
  ],
  footer_gallery_more: {
    image: '/img/foot-more.jpg',
    href: 'https://www.instagram.com/doorstep_tailor_drapper/',
  },
  footer_tags: [
    { text: 'Formal Suit', href: '/suit-blazer/formal-suit' },
    { text: 'Party Suit', href: '/suit-blazer/party-suits' },
    { text: 'Casual Suit', href: '/suit-blazer/casual-suit' },
    { text: 'Tuxedo', href: '/suit-blazer/tuxedo' },
    { text: 'Bandhgala Suit', href: '/ethnic-wear/bandhgala-suit' },
    { text: 'Kurta Jacket', href: '/ethnic-wear/kurta-jacket' },
    { text: 'Indo Western', href: '/ethnic-wear/indo-western' },
    { text: 'Sherwani', href: '/wedding-attire/sherwani' },
    { text: 'Formal Shirt', href: '/regular-wear/shirts' },
    { text: 'Casual Shirt', href: '/regular-wear/shirts' },
    { text: 'Simple Kurta', href: '/kurta/simple-kurta' },
    { text: 'Punjabi Kurta', href: '/kurta/punjabi-kurta' },
    { text: 'Pathani Kurta', href: '/kurta/pathani-kurta' },
    { text: 'Designer Kurta', href: '/kurta/designer-kurta' },
    { text: 'Tie', href: '/accessories/tie' },
    { text: 'Broch', href: '/accessories/broch' },
    { text: 'Cufflink', href: '/accessories/cufflink' },
    { text: 'Pocket Square', href: '/accessories/pocket-square' },
    { text: 'Malas', href: '/wedding-accessories/malas' },
    { text: 'Safa, Turban', href: '/wedding-accessories/safa-turban' },
  ],
  newsletter_heading: 'Signup For Newsletter',
  copyright: 'Callmytailor © 2026 All Rights Reserved.',
};
save('site.json', site);
