export function WhatsAppFab({
  ...
  return (
    <a
      href={`https://api.whatsapp.com/send?phone=${n}${text}`}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat on WhatsApp"
      className={`fixed z-50 grid h-14 w-14 place-items-center rounded-full bg-wa text-2xl text-white shadow-pop transition-transform hover:scale-105 ${
        liftOnMobile ? "bottom-20 md:bottom-5" : "bottom-5"
